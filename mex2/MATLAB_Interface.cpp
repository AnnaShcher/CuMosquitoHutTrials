...
int main(int argc, char* argv[])
{
	...
	std::cout << computation_context.hostIn << " " << computation_context.devDead << " " << computation_context.devTrap << " " <<
		computation_context.hostFed << " " << computation_context.hostUnfDead << std::endl;
	shutdown(computation_context);
